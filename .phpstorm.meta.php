...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/tom/Documents/PROJECT/siyandi/public/storage' => 'string',
...
'app.aliases.URL','app.aliases.Validator','app.aliases.View','app.aliases.PDF','app.aliases.Excel',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./home/tom/Documents/PROJECT/siyandi/public/storage','logging.default','logging.deprecations.channel',
...
'web','api',);
        registerArgumentsSet('routes', 'peta.index','peta.detail','export.varietas.excel','export.varietas.pdf',
'export.deskripsi.pdf','export.deskripsi.excel','export.materigenetik.excel','export.materigenetik.pdf','home',
'profile.struktur','profile.tugas','admin.super.dashboard','admin.operator.dashboard','admin.verifikator.index',
'admin.verifikator.dashboard','admin.verifikator.permohonan.index','admin.verifikator.permohonan.show','admin.verifikator.permohonan.approve','admin.verifikator.permohonan.reject',
'admin.verifikator.permohonan.perbaiki','admin.verifikator.permohonan.uploadKeputusan','admin.verifikator.permohonan.updatePengambilan','admin.verifikator.autoCancel','admin.verifikator.permohonan.regenerate',
'admin.keuangan.dashboard','admin.manager.dashboard','admin.kabupaten.dashboard','admin.varietas.index','admin.varietas.create',
'admin.varietas.store','admin.varietas.show','admin.varietas.edit','admin.varietas.update','admin.varietas.destroy',
'pemohon.dashboard','pemohon.permohonan.index','pemohon.permohonan.create','pemohon.permohonan.store','pemohon.permohonan.show',
'pemohon.permohonan.edit','pemohon.permohonan.update','pemohon.permohonan.destroy','pemohon.permohonan.upload','pemohon.permohonan.uploadStore',
...
'admin.kabupaten.dashboard','admin.kabupaten.varietas.create','admin.kabupaten.varietas.edit','admin.kabupaten.varietas.index','admin.keuangan.index',
'admin.layouts.admin','admin.manager.index','admin.operator.index','admin.superadmin.index','admin.verifikator.index',
'admin.verifikator.show','auth.confirm-password','auth.forgot-password','auth.login','auth.register',
...
'dashboard','docx.surat_pengambilan','docx.surat_penolakan','exports.deskripsi_pdf','exports.materi_pdf',
'exports.varietas_pdf','layouts.app','layouts.bootstrap','layouts.guest','layouts.navigation',
'partials.footer','partials.navbar','pdf.surat_pengambilan','pdf.surat_permohonan','pemohon.permohonan.create',
'pemohon.permohonan.edit','pemohon.permohonan.index','pemohon.permohonan.show','pemohon.permohonan.upload','peta.index',
'profile.edit','profile.partials.delete-user-form','profile.partials.update-password-form','profile.partials.update-profile-information-form','profile.struktur-organisasi',
'profile.tugas-fungsi','welcome','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state','laravel-exceptions-renderer::components.file-with-line',
