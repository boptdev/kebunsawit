...
<p><strong>Perihal : Permohonan Pembelian Benih Tanaman Perkebunan</strong></p>
...
<p>dengan ini mengajukan permohonan pembelian benih :</p>
...
<table style="width:100%;">
    ...
    <tr><td>Jumlah</td><td>: {{ $permohonan->jumlah_tanaman }} {{ $permohonan->jenis_benih === 'kecambah' ? 'butir' : 'batang' }}</td></tr>
