    ...
    <div class="container-fluid py-4">
        ...
        <div class="row mb-3 align-items-center">
            <div class="col">
                <div class="d-flex align-items-center gap-2 mb-1">
                    ...
                    <h1 class="h5 mb-0">Pembinaan Kebun Benih Sumber</h1>
                </div>
                <p class="text-muted small mb-0">
                    Kelola pengajuan pembinaan kebun benih sumber, susun sesi pertemuan, dan pantau status pelaksanaannya.
                </p>
            </div>
        ...
        <div class="card border-0 shadow-sm mb-3">
            <div class="card-body py-2">
                <form method="GET"
                      action="{{ route('admin.verifikator.pembinaan_kbs.index') }}"
                    ...
                    <div class="col-md-4 col-lg-3">
                        ...
                        <input type="text"
                               ...
                               placeholder="Nama / NIK / komoditas / email pemohon"
                               value="{{ $search }}">
                    </div>
                    <div class="col-md-4 col-lg-3">
        ...
        <div class="card border-0 shadow-sm mb-4">
            <div class="card-header card-header-soft d-flex justify-content-between align-items-center">
                <div class="d-flex flex-column">
                    <span class="fw-semibold small">Daftar Pengajuan Pembinaan KBS</span>
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-header card-header-soft fw-semibold small d-flex justify-content-between align-items-center">
                <span>Sesi Pembinaan Kebun Benih Sumber</span>
                <span class="text-muted small">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <span class="badge bg-secondary-subtle text-secondary">
                                            {{ $sesi->peserta_kbs_count }} peserta
                                        </span>
                                    </td>
                                    <td class="text-center">
                                        @php
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('admin.verifikator.pembinaan_kbs.sesi.show', $sesi) }}"
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                <form id="createSesiForm"
                      action="{{ route('admin.verifikator.pembinaan_kbs.sesi.store') }}"
                      method="POST"
                      enctype="multipart/form-data">
                    @csrf
                    <div class="modal-header">
                        <h5 class="modal-title" id="createSesiModalLabel">Buat Sesi Pembinaan KBS</h5>
